 ...
 * @author Artem
 */
public class AddBookFrame_test extends javax.swing.JFrame {

    /**
     * Creates new form AddBookFrame_test
     */
    public AddBookFrame_test() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Год публикации:");

        jLabel5.setText("Номер полки:");
        ...
        jLabel9.setText("Авторы книги:");

        jLabel8.setText("Все авторы:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBookFrame_test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddBookFrame_test().setVisible(true);
            }
        });
    }
